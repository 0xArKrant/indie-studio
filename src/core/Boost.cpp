...
{
    this->_model.DrawModel(this->_pos, 0.5f, Misc::Colors(255, 0, 0, 255));
}
...
{
    this->_model.DrawModel(this->_pos, 0.5f, Misc::Colors(255, 255, 255, 255));
}
...
{
    this->_model.DrawModel(this->_pos, 0.5f, Misc::Colors(0, 0, 0, 255));
}